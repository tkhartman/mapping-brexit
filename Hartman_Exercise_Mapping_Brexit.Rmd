...
The shapefile is contained in a compressed .7z format and can be downloaded directly from Github (the file is originally from Ordinance Survey). Make sure that the file is downloaded to your working directory or R will be unable to import it. Note that you'll need a separate program that can unzip .7z files (see https://www.7-zip.org/download.html).
...
url.shp <- "https://github.com/tkhartman/mapping-brexit/raw/master/eu_ref_esri.7z"
file.zip <- "eu_ref_esri.7z"

## Download shapefile if it's not present
if (!file.exists(file.zip)) 
    download.file(url = url.shp, destfile = file.zip, mode = "wb")

## NOTE: Manually unzip using a program like 7-zip
